 ...
 */
export function mapFimbaAgendaRowsForPdf(rows, { flotaById = null, sequencesByVehicle = null } = {}) {
  return (rows || []).map((ev) => {
...
export function exportFimbaAgendaToPDF(
  filteredRows,
  { title = "Agenda FIMBA", subTitle = "", flotaById = null, sequencesByVehicle = null } = {},
) {
