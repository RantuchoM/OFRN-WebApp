    ...
    <div className="mb-8 p-4 bg-slate-50 border border-slate-200 rounded-lg">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {logos.map((logo) => {
              ...
              const imgSrc = getDirectDriveLink(
                isEditing ? editFormData.url : logo.url,
              );

              return isEditing ? (
                <div
                  key={logo.id}
                  className="bg-indigo-50 p-3 rounded border border-indigo-200 shadow-sm flex flex-col gap-2"
                >
                ...
                <div
                  key={logo.id}
                  className="bg-white p-2 rounded border border-slate-200 shadow-sm flex items-center gap-3 group hover:border-indigo-300 transition-colors"
                >
      ...
      <div className="flex flex-col sm:flex-row gap-2 items-end pt-3 border-t border-slate-200">
        ...
        <button
          ...
          className="bg-indigo-600 text-white px-3 py-2 rounded text-xs font-bold hover:bg-indigo-700 flex items-center gap-2 h-[34px]"
        >
          {adding ? (
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              {difusionData?.link_logo_1 && (
                <SpecificLogoPreview url={difusionData.link_logo_1} />
              )}
            </div>
            <div>
              <EditableField
              ...
              {difusionData?.link_logo_2 && (
                <SpecificLogoPreview url={difusionData.link_logo_2} />
              )}
            </div>
          </div>
        </section>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      {details.link_foto_popup && (
                        <SpecificLogoPreview url={details.link_foto_popup} />
                      )}
                    </div>
                  </div>
                </div>
