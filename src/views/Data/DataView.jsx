  ...
  const tableConfigs = {
    ...
    locaciones: {
      ...
      columns: [
        ...
        {
          key: "escenario_ancho_cm",
          label: "Escenario ancho (cm)",
          type: "int8",
        },
        {
          key: "escenario_profundo_cm",
          label: "Escenario profundo (cm)",
          type: "int8",
        },
        { key: "link_mapa", label: "Google Maps", type: "text" },
        { key: "latitud", label: "Latitud", type: "float" },
        { key: "longitud", label: "Longitud", type: "float" },
        { key: "telefono", label: "Teléfono", type: "int8"},
        { key: "mail", label: "E-mail", type: "text" },
      ],
      // --- AVISO ---
      warning:
        "📍 Nota: Si editas una locación vinculada a un hotel, nombre, dirección, localidad y Google Maps se espejan al hotel. Para crear hoteles, usá la pestaña 'Hoteles'. Ancho/profundo de escenario (cm) alimentan el preset del plano de escenario.",
    },
    hoteles: {
      label: "Hoteles",
      icon: IconHotel,
      ...
      columns: [
        ...
        },
        {
          ...
          options: [
            ...
            { value: "tubular_bells", label: "tubular_bells" },
