...
export const IconMusic = ({ size = 24, className = "" }) => (
  <svg
...
export const IconShare = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconFileExcel = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconClip = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconCamera = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconCar = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconBulb = ({ size = 24, className = "", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconPalette = ({ size = 24, className = "", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconScissors = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconMap = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconFolderPlus = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconGripVertical = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconFileLink = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
/** Git-merge style — unificar / fusionar duplicados */
export const IconMerge = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconUndo = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconColumns = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
  ...
  >
    ...
    <path d="M3 9a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z" />
    <path d="M17 9a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1z" />
  </svg>
);
...
export const IconHotel = ({ size = 24, className = "" }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M18 20V8h-5V4H6v16" />
    <path d="M2 20h20" />
    <path d="M6 14h12" />
  </svg>
);
export const CuratorIcon = ({ size = 24, className = "" }) => {
  // Calculamos el aspect ratio para mantener la proporción de la imagen original
  const width = size;
  const height = (size * 559) / 1024;
  ...
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M651.5 118.5c.9-6.7 1.2-13.5-.6-20-1.4-4.9-6.5-8.8-10.4-8.6-3 .1-6-.4-9-.4-82.5 0-165 0-247.5.1-3.5 0-7.4-.2-10.4 1.1-6 2.6-8.1 8-8.1 14.3 0 7.7 0 15.3 0 23 0 99.5 0 199 0 298.5 0 6.1.9 11.6 6.4 15.6 3 2.2 6.3 2.4 9.5 2.4 12.7-.1 25.4.7 38.1-.4 3.7-.3 7.1 1 9.9 3.1 1.6 1.2 3 1.4 4.6 1.4 21.2-1 42.4-2.2 63.6-2.9 15.2-.6 30.4-1.2 45.6-1.1 23 .2 46 .1 69 0 4 0 8.1.2 11.6-2.9 3.6-3.2 5.5-6.7 5.5-11.6-.1-24.5 0-49 0-73.5 0-.7.2-1.4.3-2" />
      <path d="M651.5 353.5c.9 12.7.2 25.3.1 38-.2 19.3.2 38.6.4 58 0 1.3.1 2.7 0 4-1.6 14.8-5.8 18.5-20.9 18.5-83 0-166 0-249 .1-7.3 0-14.9-3-17-11.5" />
      <path strokeWidth="4" d="M700.5 353.5c-11.6-6.2-23.7-10.7-36.5-13.4-14.8-3.1-29.8-4.1-45-3.2-33.1 1.8-63.5 13-93.5 25.7-14.3 6.1-28.7 12-43.5 16.4-20.9 6.2-42 11-64 11.2-11.7.1-23.4.4-35-2.1" />
      <path d="M364 121c-2.5 0-5 .3-7.5 0-8.1-1.1-15.7 7.4-15.7 15.5.3 70.3.2 140.6.3 211 0 3.2 0 6.7-2.2 8.9-2.3 2.3-1.9 4.7-1.8 7.1.8 15.8 1.7 31.6 2.5 47.4.6 11.2.7 22.4 1.6 33.6.6 8.2 7.1 15.1 17.4 14.7 13.7-.6 27.2-2.9 41-3.4 7.6-.3 15.3-1.5 23-1.8 3.1-.1 5-2.1 7-4" />
      <path strokeWidth="4" d="M701.5 215c-13.8-5.4-27.6-10.2-42.5-12.1-17.9-2.3-35.5-1.4-53.1 2.1-25.1 5-48.4 15-71.5 25.6-23.6 10.9-47.4 21.2-72.6 27.8-13.3 3.5-27 6.3-41 6.2-2 0-4.2.3-5.5-2" />
      <path strokeWidth="4" d="M701.5 147.5c-9.1-2.4-17.8-5.8-27-8.1-23.3-5.9-46.7-5.6-70 .2-27.3 4.5-52.6 14.9-77.6 26.4s-50.6 11.5-77.5 17.4c-9.7 2.1-19.7 4.3-29.9 3.2" />
      <path strokeWidth="4" d="M701.5 280c-15.4-5.8-31.1-10-47.5-11.5-12.7-1.2-25.3-1.1-38 0-11.4 1.3-22.5 3.4-33.5 6.1-12.2 3.1-23.9 7.3-35.5 12.1-19.4 8.1-38.3 17.4-58.1 24.4-23.1 8.2-46.7 14.6-71.5 15.2-3.6 0-7.5-.3-10.5 2.4" />
      <path d="M339.8 151c-4.8-.1-9.5.9-14.3 1.2-7.1.4-11.6 6.1-11.5 13.3.1 10.3 1.8 20.4 2.8 30.6.7 7.7 1.4 15.4 2.2 23 1 8.7 1.3 17.4 2.8 26.1.8 4.2.6 8.6 1.1 13 1.5 12.8 2.2 25.7 4 38.5 1.2 8.1 1.4 16.3 2.1 24.5.9 10.2 1.9 20.3 3.1 30.5.3 2.4 2.1 4.3 3.9 6" />
      <path strokeWidth="4" d="M701.5 164.5c-7.5-2.5-14.9-5.4-22.5-7.4-16.5-4.5-33.3-6.7-50.5-5.1-1.6.1-4.7 1.4-4.3-2.4" />
      <path strokeWidth="4" d="M476 202c-7.7 2-15.3 4.2-23 6-12.2 2.7-24.6 3.8-37 5-2 .2-3.3-1.3-5-2" />
      <path strokeWidth="4" d="M632 318c-3.8 2.9-8.4 1.6-12.5 1.8-10.3.5-20.4 2.6-30.5 4.2-6.1.9-11.4 4.3-17.1 5.7-5.7 1.4-11.5 2.3-16.9 4.4-13.6 5.3-27.2 10.6-40.5 16.5-11.1 4.9-22.4 10.1-34.1 12.5-12.4 2.5-24 7.6-36.9 8.8-12.5 1.2-25 2.6-37.5 2.7-2.4 0-4.5-.5-6.5-1.6" />
      <path strokeWidth="4" d="M700 298c-17.8-8-36.6-12.6-56-12.6-6.2 0-8.4-2.5-11-6.4" />
      <path strokeWidth="4" d="M473 350c-6.5.4-12.6 2.8-19 4-11.1 2.1-22.3 3.6-33.5 4.4-2.3.2-4.7.4-6.5-1.4" />
      <path strokeWidth="4" d="M476 330.5c-1.2 3-4 2.9-6.5 3.5-13.1 3.5-26.4 6.5-40 7.5-4.8.3-9.7.7-14.5 1" />
      <path strokeWidth="4" d="M636 299.5c-3.9 3.6-9 2.6-13.5 2.9-20.3 1.2-39.9 5.5-59 12.1-11.7 4-23.2 8.5-34.5 13.6-1.5.7-2.9 1.1-4.5 1" />
      <path strokeWidth="4" d="M512 206c-6.6 1-12.4 4.2-18.4 6.7-20.7 8.4-42.1 13.7-64.1 16.8-3 .4-6.4-1.2-9 1.5" />
      <path strokeWidth="4" d="M636 284.5c-8.3 1-16.7.4-25 2-1.3.1-1.7.2-2 0-8-4.9-15.3 1.8-23 1.5-7.8 7.2-18.6 6.8-27.6 10.9-9.1 4.1-18.6 7.4-27.9 11.1-6 2.3-9 6.3-8.1 13 1 7.6-1.4 15.3 0 23" />
      <path strokeWidth="4" d="M623.5 150.5c-11.7 2.8-23.4 5.7-35 9-7.7 2.2-16 2.9-23.4 5.9-5.9 2.4-12 4.3-17.7 7.1-9.1 4.4-18.5 8.3-27.9 12-4.4 1.7-6 5.1-6.4 9.1-.4 3.4-.6 7 .3 10.4" />
      <path strokeWidth="4" d="M582 198c-2.6-2.1-5.4-2.4-8.5-1-5.3 2.3-11.3 2.7-15.8 7.8-2.6 3-7.3 4.7-12.2 4.4-5.6-.4-9.8 4-14.9 5.5-5.8 1.7-10.8 5.3-17 6.7-3.4.8-6.4 4.7-10.1 6.1-8.4 3-17 5.4-25.5 8.1" />
      <path strokeWidth="6" d="M407 210c-6.1-8.1-4.1-24.7 1.9-30.6 4-4 6-4 8.6 1.1 4.6 9 1.2 16.9-3.6 24.5-2.8 4.4-7.1 7.5-11 10.9-6.2 5.4-12 11.2-14.8 19-3.5 10 .6 18.8 7.8 24.6 5.8 4.7 11.9 5.1 19.3 3.3.4 5.1 1.2 10.1 1.2 15.1 0 4.8-2.8 8-7.4 9.5-3.4 1.1-6.7 1-9.5-1.5-2.5-2.2-2.3-5 0-7.7" />
      <path strokeWidth="4" d="M523.5 315c-5.5-.3-9.7 3.4-14.5 5-7.3 2.6-14.4 5.7-21.6 8.4-1.8.7-3.5 1.3-4.9 2.6" />
      <path strokeWidth="4" d="M700.5 198c-15.7-6.6-31.9-11-49-12.6-8.1-.8-16-.7-24-.4-1.7.1-2.5 1.1-3.5 2" />
      <path strokeWidth="5" d="M525 199c-4.5-9.8-10.3-11.8-20-8.1-8.6 3.2-16.8 7.6-26 9.1-1.6.3-2.8 1-2.4 2.6 1.2 5.1-.4 10.4 1 15.4" />
      <path strokeWidth="4" d="M595 173c8-1.3 16-2.8 24-3.9 11.1-1.5 22.3-1.4 33.5-.4 3.3.3 6.5.5 9.5-.7 1.8-.7 1.1 1 1.8 1.1" />
      <path strokeWidth="4" d="M461 241.5c-4.5 0-8.7 1.8-13 2.4-7 1.1-13.9 3-21 2.1" />
      <path strokeWidth="4" d="M560 185c-9.9 2.8-18.9 7.8-28.5 11.6-6.5 2.6-12.8 5.8-19.1 8.7 1 5.3.3 10.3.5 15.3" />
      <path strokeWidth="4" d="M522.5 332c-3.6-.9-6.5 1.3-9.4 2.6-12.3 5.5-24.7 10.6-38 13.4-.6.1-1 .9-1.5 1.4.4 4.6 1.7 9.3-1.5 13.5" />
      <path strokeWidth="4" d="M638.5 302c8.3 0 16.3 1.6 24.5 2.5 6.6.8 8.5-.6 8.5-7" />
      <path strokeWidth="5" d="M592.5 159c2.7 4.4.7 9.4 2.1 14.5-11.8 2.5-22.7 7.5-34.5 10.4 2 5.8-.4 11.4 1.9 16.6" />
      <path d="M651.5 219.5c.8 10.3.8 20.7 0 31" />
      <path strokeWidth="5" d="M472.5 317.5c.8 2.2 1.8 4.3 2.2 6.5.7 3.3 2.1 5.5 5.3 7.2 5 2.6 7 7.7 8.5 12.8" />
      <path strokeWidth="5" d="M405 217.5c1.9 2.3 2.5 5 3.1 8 2.3 12.4 3.4 25 7.4 37" />
      <path strokeWidth="7" d="M414.5 342c-.9-8.4-6.2-12.8-14.5-14.2-4.8-.8-9.6-2-14.5-2.8-1.7-.3-3.3-.3-5-.4" />
      <path strokeWidth="5" d="M476.5 220c1 6.8.7 13.7.4 20.5-.2 4.5-7.7 9.5-12 8.5-3.8-.9-5.2-5.5-2.5-8.5 3.9-4.3 8.9-5.6 14.5-5" />
      <path strokeWidth="4" d="M408.5 360c-3.4-1.9-7.2-1.7-11-2-5-.4-10-1-15-1.5" />
      <path strokeWidth="4" d="M674.5 172.5c8.7 2.1 17.2 5 25.5 8.5" />
      <path strokeWidth="4" d="M382.5 338.5v2c6-.5 11.2 3.5 17.5 2.2 4.8-1 10-.2 15-.2" />
      <path strokeWidth="7" d="M416 262c4.3-3.1 8.3-6.1 9.6-12 2.2-9.8-5.9-18.9-15.6-17" />
      <path strokeWidth="5" d="M402.5 195c-6.7.3-13.4-.5-20-1.5" />
      <path strokeWidth="4" d="M613.5 189c-2.2-2.6-4.8-1.6-7.5-1-3.7.8-7.4 1.4-11 2.1" />
      <path strokeWidth="4" d="M700 316c-5.5-1.9-10.7-4.6-16.5-6.1-2.7-.7-4.5-2.2-1.5-5 1-1 1.7-2.3 2.5-3.5" />
      <path strokeWidth="4" d="M399.5 214c-3.3-3.2-7.7-1.4-11.5-2.5-1.8-.5-3.7-.7-5.5-1" />
      <path d="M415.5 343.5c-.2.8-.4 1.6-.5 2.5-.6 7.4-4.3 13.1-9 18.6-2.3 2.7-5.6 4.2-7.3 7.8-.8 1.7-5 3.2-8.1 1.7-2.4-1.2-4.9-1.5-7.5-1.5" />
      <path strokeWidth="5" d="M626 169v16M582.5 309.5c.7 5.2 1.3 10.5-1 15.5M625.5 152.5c.3 5.2.7 10.3 1 15.5M582.5 292.5c1.4 5.1-.3 10.4 1 15.5" />
      <path strokeWidth="4" d="M399 263c-3.3 2.9-7 1-10.5.9-1.6-.1-3.3-.3-5-.4" />
      <path strokeWidth="5" d="M593.5 174.5c-.1 6.8 2.9 13.8-2.4 20.1-1.4 1.6-2.7 3.4-4.6 3.8-3.7.6-3.7 3-3.5 5.6" />
      <path strokeWidth="4" d="M681.5 310l-6 15" />
      <path strokeWidth="5" d="M561 168.5c.2 4.8-.5 9.7.5 14.5M473.5 334c1.4 4.6-.3 9.4 1 14" />
      <path strokeWidth="5" d="M664.5 169c2.2 3.3 6.4.9 9.5 3.1-2 4.9-4.3 9.7-5.5 14.9" />
      <path strokeWidth="4" d="M397 329c-.8.6-1.5 1.2-2.4 1.6-5.3 2.7-6 4.4-5 10.4" />
      <path strokeWidth="6" d="M408 232.5c-5.8 3.1-8.9 8.3-8.6 13.5.2 4.1 4.1 5.5 5.6 8.5" />
      <path strokeWidth="4" d="M526 200c1.7 4.3.3 8.2-1.5 12" />
      <path strokeWidth="8" d="M640 310c-9.3 3.4-10 8-2.5 15.5.3.2.7.3 1 .5" />
      <path strokeWidth="5" d="M394 228c2.8 3.2 7.8.7 10.5 4M487 346c1 3-.5 5.5-3.5 7" />
      <path strokeWidth="8" d="M639 286.5c1.3 3.3 1.6 6.2-1.3 9.1-1.1 1.1-2 3.6-.2 6 1.4 1.7 2.1 4.1 2.5 6.4.6 3.3 2.9 4.2 5.5 5" />
    </svg>
  );
};
export const IconBed = ({ size = 24, className = "" }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M2 20v-2a4 4 0 0 1 4-4h12a4 4 0 0 1 4 4v2" />
...
export const IconTruck = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconSkipBack = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconSkipForward = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconRepeat = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconCalendarPlus = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconLinkOff = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    className={className}
  >
    <path d="M18.84 12.25l1.66 1.67a5 5 0 0 1-7.07 7.07l-1.72-1.71" />
    <path d="M5.17 11.75l-1.67-1.67a5 5 0 0 1 7.07-7.07l1.71 1.71" />
    <line x1="2" y1="2" x2="22" y2="22" />
  </svg>
);
...
export const IconPrinter = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconCloudUpload = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconUtensils = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// Agrega esto al final o junto a tus otros íconos en Icons.jsx
export const IconArrowDown = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconArrowUp = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconBan = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconBus = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconBusGrande = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconVan = ({ size = 24, className = "" }) => (
  <svg
    ...
    className={className}
  >
    <path d="M1597 903.6c0-35.3-27.7-64.4-63-66.1l-321-15.6-93.4-121.8c-15.2-19.9-38.8-31.5-63.9-31.5H907.2c-23.6 0-43.7 17.3-47.1 40.7l-25.5 172.9H272.8v236.5h97.6l5.6-16.9 21.5-64.6c9.5-23.5 32.3-38.9 57.7-38.9h103.9c34.2 0 62 27.8 58.5 62v91.4h663.9l5.6-20 26.4-94.1c12-29.8 40.9-43.9 73-43.9h86.5c32.6 0 61.9 14.3 74.1 44.5l4.7 11.7 32.4 80.2h49.3c21.8 0 39.5-17.7 39.5-39.5V965.8c0-32.8-26.6-59.3-59.3-59.3h-257.5c-33.7 0-65.8 14.4-88.3 39.6-19.3 21.7-35.2 46-47.2 72.1-12 26.1-20.1 54-24 82.7l-7.9 49.3" />
    <path d="M1469.7 993.6c36.8 21.5 61.4 61.4 61.4 107.1 0 68.5-55.5 124-124 124-57.8 0-106.3-39.6-120.1-93.1" />
    <path d="M617.6 1139.9c-16.4 49.2-62.9 84.8-117.6 84.8-68.1 0-123.4-54.9-124-122.9v-1" />
    <path d="M272.8 1118.6h-55.9" />
    <path d="M290 1118.6l52.1-116.8c17.2-37.2 54.4-60.9 95.3-60.9H623c55.9 0 101.2 45.3 101.2 101.2v108" />
    <path d="M813.1 883.5v260.9" />
    <path d="M912 899.3h47.3" />
    <path d="M912 820.5l10-90.3h137.6l61.6 90.3z" />
    <path d="M543.2 1101.6c0 25.6-20.8 46.4-46.4 46.4-25.6 0-46.4-20.8-46.4-46.4 0-25.6 20.8-46.4 46.4-46.4 25.7 0 46.4 20.8 46.4 46.4z" />
    <path d="M1454.2 1101.6c0 25.6-20.8 46.4-46.4 46.4-25.6 0-46.4-20.8-46.4-46.4 0-25.6 20.8-46.4 46.4-46.4 25.6 0 46.4 20.8 46.4 46.4z" />
    <path d="M1551.7 1049.8h150" />
  </svg>
);

export const IconPlane = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
/** Violín/arco (trazo tipo Potrace basado en recurso de modelo para columna Arcos). */
...
export const IconSortDesc = ({ size = 16, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconSpiralNotebook = ({ size = 24, className = "" }) => (
  ...
  >
    ...
    {/* 3. Cuadrado vacío - Antes x=9... ahora x=10 */}
    <rect x="10" y="17" width="4" height="4" rx="1" />
  </svg>
);
export const IconPhoto = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconBold = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconItalic = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconUnderline = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconAlignLeft = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconAlignCenter = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconAlignRight = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconFilePlus = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconMegaphone = ({ size = 24, className = "" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconCalculator = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconGrid = ({ size = 24, className = "" }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconCheckSquare = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// Opcional: Versión rellena (más reconocible como marca)
export const IconWhatsAppFilled = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    viewBox="0 0 24 24"
    fill="currentColor" // Usa fill para que tome el color del texto
    className={className}
  >
...
export const IconCake = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconFiles = ({ size = 24, className = "" }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
...
export const IconBox = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconScissor = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const IconLayoutList = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
/** Copa de competencia (trofeo) — menú Concerto Competition */
export const IconTrophy = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
