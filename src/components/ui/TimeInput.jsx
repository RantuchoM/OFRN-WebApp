    ...
    <div className="w-full">
      ...
      <div className="relative group">
        ...
        <button
          ...
          className={`absolute right-0 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded transition-all z-10 ${
            showClear ? "opacity-100" : "opacity-0 group-hover:opacity-100"
          }`}
          title="Abrir reloj"
        >
          <IconClock size={14} />
              ...
              <div className="flex items-center gap-2">
                {showClear && (
                  <button
                    type="button"
                    onClick={clearClock}
                    className="rounded-md border border-slate-200 bg-white px-2 py-1 text-[11px] font-bold uppercase text-slate-600 hover:bg-slate-50"
                  >
                    Limpiar
                  </button>
                )}
