...
```bash
# npm
npm i rb-tippyjs-react

# Yarn
yarn add rb-tippyjs-react
```

CDN: https://unpkg.com/rb-tippyjs-react
...
```jsx
import React from 'react';
import Tippy from 'rb-tippyjs-react/headless'; // different import path!
...
```jsx
import Tippy, {useSingleton} from 'rb-tippyjs-react';
...
```jsx
import Tippy, {useSingleton} from 'rb-tippyjs-react/headless';
