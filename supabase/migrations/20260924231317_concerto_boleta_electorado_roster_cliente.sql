-- La convocatoria (ensamble, familia, exclusiones) la resuelve el cliente
-- con fetchRosterForGira. Esta función no la recalcula: solo exige estable,
-- no vacante, y rechaza una fila personal ya marcada ausente.
...
comment on function public.concerto_guardar_boleta(bigint, bigint, jsonb) is
  'Guarda la boleta. Exige estable y no vacante, y rechaza ausente en giras_integrantes. Quién está convocado lo decide el cliente con fetchRosterForGira.';
