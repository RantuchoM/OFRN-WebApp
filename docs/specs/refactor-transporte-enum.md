...
- `useAgendaData.js` (2026-09-22): caché `v11`. Snapshot slim (sin roster completo ni `eventos_logs` ni rider FIMBA). `QuotaExceededError` recorta `agenda_cache_*`, reintenta una vez y, si falla, omite caché sin abortar el pintado de red.
