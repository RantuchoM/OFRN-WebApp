...
| Export pestaña oculta | `src/utils/pdfLibBackgroundSafe.js` + `ViaticosManager.processExportList` / `appendPersonToDoc` + `pdfFormExporter` load/save |
