...
- **Sidebar**: se agrega un botón de torta junto a modo oscuro y escala de interfaz. Abre un modal en portal (`document.body`, `z-[100]`) con cumpleaños de hoy y próximos 30 días. El badge numérico solo aparece cuando hay cumpleaños **hoy**; si no hay ninguno ese día, el botón queda sin número.
