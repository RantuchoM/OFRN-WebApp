...
- **Repertorio** (`RepertoireManager`): multi-select de grupos en el header del bloque, solo si la gira tiene grupos; placeholder “Todos…”. Músicos ven chips (sin control) cuando hay asignación.
