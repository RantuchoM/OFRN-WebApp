...
- **Detalle de contenedor (particellas individuales):** las filas de persona al expandir VIOLÍN 1 / etc. usan los mismos `seating_contenedores_items` ya recortados (ausentes fuera, vacantes sí). No hay entidad de divisi aparte.
