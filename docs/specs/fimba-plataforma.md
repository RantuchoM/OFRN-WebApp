...
- [x] Planilla muestra orquesta OFRN (tutti/grupos) + badges origen + filtro Todos/FIMBA/OFRN (**default Todos**) + categoría (dropdown multi). **Tutti** en Grupos OFRN (off por defecto); orquesta se carga con Todos/OFRN o al marcar Tutti/grupo
...
- [x] Planilla agenda: badges FIMBA/OFRN + convocatoria + filtro origen (default **Todos**) + banner filtros activos + multi-select **categoría**, **locación**, **artista** y **grupos OFRN** (incluye **Tutti** off) + búsqueda debounced (tipo/actividad/lugar/personas/vehículos)
...
- [x] **Tutti en Grupos OFRN (2026-09-02):** opción Tutti off por defecto; planilla default **Todos** (2026-09-08; antes Solo FIMBA); filtro artista ya no fuerza origen Todos ni incluye convocatoria orquesta; marcar Tutti o un grupo carga `include_ofrn` (unión con agenda FIMBA)
