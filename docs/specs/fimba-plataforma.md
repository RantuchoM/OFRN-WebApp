...
6. Columnas planilla: **Origen** (org) · **Fecha** · **Com** · **Detalle** · **Origen** (locación) · **H. Llegada** · **+** · **Destino** · **Vehículo** · **Subidas** · **Bajadas** · **Tránsito/cap** · acciones. Sticky izq. Origen/Fecha/Com. Scroll en `.fimba-planilla-scroll` (`overflow:auto`, card con max-height) para thead sticky. Chips Subidas/Bajadas (clic → modal; × quita FIMBA; Reserva del evento **solo si residual > 0**). **H. Llegada** = hora com del next **asignado** (columna secundaria); **—** si no hay. Alerta **Sobre cupo** si en_transito > capacidad; Tránsito/cap hover = desglose a bordo.
