...
4. UI: chip «Agenda»; caption «Grupo · …» en override; badges **Llegada anticipada** / **Check-in propio** / **Salida posterior**. Hotelería, planilla edición (RO), nómina expandida y token consulta muestran etiqueta de evento (`formatStayEventLabel`).
