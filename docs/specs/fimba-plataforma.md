...
| `src/views/Fimba/FimbaEventoFormModal.jsx` | Modal agenda + flota; **Detalle** rich-text (`eventos.descripcion`); Asientos/Obs. Equipaje; Repartir; Sube/Baja; Orquesta OFRN; dirty-guard cierre |
