...
- **Referencias de material:** Tabla `public.arreglos_referencias`. Modal `ArreglosReferenciasModal` con `overlayClassName` `z-[10050]` (por encima de WorkForm en modales anidados). Picker de obra: `z-[10100]`.
